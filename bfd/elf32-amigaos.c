...
extern void ppc_elf_amigaos_begin_write_processing
  PARAMS ((bfd *, struct bfd_link_info *));
extern void ppc_elf_amigaos_final_write_processing
  PARAMS ((bfd *, bfd_boolean));
extern bfd_boolean ppc_elf_amigaos_write_section
...
void
ppc_elf_amigaos_begin_write_processing (abfd, link_info)
     bfd *abfd;
     struct bfd_link_info *link_info;
{
  bfd *ibfd;
...
bfd_boolean
ppc_elf_amigaos_write_section (abfd, asec, contents)
     bfd *abfd ATTRIBUTE_UNUSED;
     asection *asec;
...
void
ppc_elf_amigaos_final_write_processing (abfd, linker)
     bfd *abfd;
